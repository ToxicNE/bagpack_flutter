  ...
  Future<List<ProductCart>> getProducts() async {
    ...
    return [
      ProductCart(
        name: 'Тархун',
        description: 'Обычный',
        image: 'https://vashnarkolog.com/wp-content/uploads/c/f/5/cf52a4a5cc40a04a752cea2296dac2b8.jpe',
      ),
      ProductCart(
        name: 'Швепс',
      ...
      ProductCart(
        ...
        image: 'https://korzina.su/upload/iblock/1e1/1e188c15647e9063d4c95f1da3a6bdcc.jpg',
      ),
      ProductCart(
        name: 'Пепси кола',
      ...
      ProductCart(
        name: 'Lipton',
        description: 'Персик',
        image: 'https://mineral-group.com/wp-content/uploads/2023/08/lipton_persik_0.25_gb-1024x1024.jpg',
      ),
    ];
  }
